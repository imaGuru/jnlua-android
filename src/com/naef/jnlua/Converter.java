...
public interface Converter {
	/** Returns the type distance between a Lua value and a formal Java type. Distances are comparable for the same Lua value only.
	 * If a Lua value cannot be converted to the specified formal type, the method returns <code>Integer.MAX_VALUE</code>.
	 * 
